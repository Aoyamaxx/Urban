...
GOOGLE_MAPS_API_KEY = 'AIzaSyBTNBrRNkhtALl6z24nX_ySG9OfQFhvq3w'
WEXTRACTOR_API_KEY = '5949b9c7cf3deb0e96a1a2c6c9b443b79b5143e5'
...
def write_reviews_to_csv(place_name, reviews):
    with open('reviews_sample_data.csv', 'a', newline='', encoding='utf-8') as file:
        writer = csv.writer(file)
        
        if file.tell() == 0:
            writer.writerow(["Location", "Author", "Rating", "Text"])
        
        for review in reviews:
            author = review.get('author', 'N/A')
            rating = review.get('rating', 'N/A')
            text = review.get('text', 'N/A').replace('\n', ' ')
            
            writer.writerow([place_name, author, rating, text])
...
if __name__ == "__main__":
    ...
    if place_id:
        ...
        while True:
            ...
            write_reviews_to_csv(place_name, reviews)
